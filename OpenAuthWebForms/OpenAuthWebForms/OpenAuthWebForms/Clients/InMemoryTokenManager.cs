...
//{
//    public class CustomInMemoryTokenManager : IConsumerTokenManager, IOpenIdOAuthTokenManager
//    {
//        private Dictionary<string, string> tokensAndSecrets = new Dictionary<string, string>();

//        public CustomInMemoryTokenManager(string consumerKey, string consumerSecret)
//        {
